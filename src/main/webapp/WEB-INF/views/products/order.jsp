    ...
    <div class="screen1">
	 <div class="screen2">
       <table width="1000" align="center">
         <caption id="option"> <h2 align="left"> 배송 옵션 <input class="update" type="button" id="update" value="편집"> </h2> </caption>
       </table>
       <p>
       <div class="address">
        <div class="baddress">
          ...
          <div class="state"> 도/광역시 , 시/구/군 , 읍/면/동 </div>
          <div class="roadname"> 도로명주소 , 상세주소 </div>
          <div class="zip"> 우편번호 </div>
          <div class="email"> 이메일 </div>
          <div class="phone"> 전화번호 </div>
        </div>
       </div>
       <div id="address-change">
        <form class="form" method="post" action="/products/order">
          ...
          <div class="input-container">
            ...
            <input class="input" type="text" value="${extra_address}" />
          </div>
          <div class="input-container">
            <label for="zip" class="input-label">
             우편번호 *
            </label>
            <input class="input" type="text" value="${zip}" />
          </div>
          <div class="input-container">
         ...
         <div id="submit">
          <input id="locationUp" type="submit" value="저장 및 계속">
       ...
       <hr>
       <table width="1000" align="center">
         <caption id="payment"> <h2 align="left">  결제  <input class="update" type="button" id="update1" value="편집" onclick="PaySelect()"> </h2> </caption>
       </table>
       <div class="payok">
        <div>
       ...
       <div>
         <div> <input type="checkbox" id="agree-checkbox"> <a href="../products/agreementservice" class="terms" target="_blank">구매 약관</a>에 동의합니다 </div>
       </div>
       <p>
       <div>
         <div id="submit">
     ...
     <div class="screen2">
       <table align="center" width="400">
         <caption id="mini-cart"> <h2 align="left"> <input class="update" type="button" id="update2" value="편집" onclick="location.href='/cart'"> 장바구니 </h2> </caption>
       </table>
